...
$headers .= 'From:ARLEXNET Contact Form Demo<info@arlexnet.com>'."\r\n";
$ms.="<html></body><div>
...
<html>
<head>
<title>ARLEXNET Contact Form With Mail function and Database store Facility</title>
		...
		<!---main--->
			<div class="main">
				...
				<div class="login-form">
					...
					<p>Feel free to drop us a line and we'll get back to you ASAP!</p>
						<span></span>
